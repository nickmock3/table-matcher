...
## 403/404秘匿方針
- 本仕様の保護APIでは、認可失敗を404へ秘匿せず `403 Forbidden` を返す。
- 未ログインは `401 Unauthorized` を返す。
- `404 Not Found` は公開リソースの不存在など、認可とは独立したケースでのみ使用する。
...
## 変更履歴
- 2026-02-20: 403/404秘匿方針を確定（保護APIは401/403を明示）
- 2026-02-18: 初版作成
